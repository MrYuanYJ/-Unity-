...
{
    public class easyEntity : AEasyEntity
    {
        
    }
    public abstract class AEasyEntity: IEasyEntity
    {
        private bool _isDispose;
        private long _id;
        private bool _isActive;
        private IEasyEntity _easyEntityImplementation;
        ...
        {
            ref T component= ref  EasyECSMgr.CreateEasyComponent<T>();

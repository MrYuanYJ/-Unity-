...
namespace EasyFramework
{
    ...
    public abstract class AutoClassEvent<T> :IAutoRegisterEvent where T : AEventIndex<T>
    {
        ...
        public IUnRegisterHandle Register<TScope>(TScope scope) => AEventIndex<T>.RegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
        public void UnRegister()=>AEventIndex<T>.UnRegisterEvent(Run);
        public void UnRegister<TScope>(TScope scope) => AEventIndex<T>.UnRegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
    }
    public abstract class AutoClassEvent<T,A> :IAutoRegisterEvent where T : AEventIndex<T,A>
    {
        ...
        public IUnRegisterHandle Register<TScope>(TScope scope)=> AEventIndex<T,A>.RegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
        public void UnRegister()=>AEventIndex<T,A>.UnRegisterEvent(Run);
        public void UnRegister<TScope>(TScope scope)=> AEventIndex<T,A>.UnRegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
    }
    public abstract class AutoClassEvent<T,A,B> :IAutoRegisterEvent where T : AEventIndex<T,A,B>
    {
        ...
        public IUnRegisterHandle Register<TScope>(TScope scope)=> AEventIndex<T,A,B>.RegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
        public void UnRegister()=>AEventIndex<T,A,B>.UnRegisterEvent(Run);
        public void UnRegister<TScope>(TScope scope)=> AEventIndex<T,A,B>.UnRegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
    }
    public abstract class AutoClassEvent<T,A,B,C> :IAutoRegisterEvent where T : AEventIndex<T,A,B,C>
    {
        ...
        public IUnRegisterHandle Register<TScope>(TScope scope)=> AEventIndex<T,A,B,C>.RegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
        public void UnRegister()=>AEventIndex<T,A,B,C>.UnRegisterEvent(Run);
        public void UnRegister<TScope>(TScope scope)=> AEventIndex<T,A,B,C>.UnRegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
    }
    ...
    public abstract class AutoClassEvent<T,A,B,C,D> :IAutoRegisterEvent where T : AEventIndex<T,A,B,C,D>
    {
        ...
        public IUnRegisterHandle Register<TScope>(TScope scope)=> AEventIndex<T,A,B,C,D>.RegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
        public void UnRegister()=>AEventIndex<T,A,B,C,D>.UnRegisterEvent(Run);
        public void UnRegister<TScope>(TScope scope)=> AEventIndex<T,A,B,C,D>.UnRegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
    }
    ...
    public abstract class AutoClassEvent<T, A, B, C, D, E> : IAutoRegisterEvent where T : AEventIndex<T, A, B, C, D, E>
    {
        ...
        public IUnRegisterHandle Register<TScope>(TScope scope)=> AEventIndex<T, A, B, C, D, E>.RegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
        public void UnRegister()=>AEventIndex<T, A, B, C, D, E>.UnRegisterEvent(Run);
        public void UnRegister<TScope>(TScope scope)=> AEventIndex<T, A, B, C, D, E>.UnRegisterEvent(GlobalEvent.GetEasyEventDic(scope), Run);
    }
}
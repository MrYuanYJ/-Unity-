...
namespace EasyFramework.EventKit
{
    public abstract class AutoClassFunc<T,R> :IAutoRegisterEvent where T : AFuncIndex<T,R>
    {
        ...
        public void Register()=>AFuncIndex<T,R>.RegisterFunc(Run);
        public void Register<TScope>(TScope scope) => AFuncIndex<T,R>.RegisterFunc(GlobalEvent.GetClassFuncDic(scope), Run);
    ...
    public abstract class AutoClassFunc<T,R,A> :IAutoRegisterEvent where T : AFuncIndex<T,R,A>
    {
        ...
        public void Register()=>AFuncIndex<T,R,A>.RegisterFunc(Run);
        public void Register<TScope>(TScope scope) => AFuncIndex<T,R,A>.RegisterFunc(GlobalEvent.GetClassFuncDic(scope), Run);
    ...
    public abstract class AutoClassFunc<T,R,A,B> :IAutoRegisterEvent where T : AFuncIndex<T,R,A,B>
    {
        ...
        public void Register()=>AFuncIndex<T,R,A,B>.RegisterFunc(Run);
        public void Register<TScope>(TScope scope) => AFuncIndex<T,R,A,B>.RegisterFunc(GlobalEvent.GetClassFuncDic(scope), Run);
    ...
    public abstract class AutoClassFunc<T,R,A,B,C> :IAutoRegisterEvent where T : AFuncIndex<T,R,A,B,C>
    {
        ...
        public void Register()=>AFuncIndex<T,R,A,B,C>.RegisterFunc(Run);
        public void Register<TScope>(TScope scope) => AFuncIndex<T,R,A,B,C>.RegisterFunc(GlobalEvent.GetClassFuncDic(scope), Run);
    ...
    public abstract class AutoClassFunc<T,R,A,B,C,D> :IAutoRegisterEvent where T : AFuncIndex<T,R,A,B,C,D>
    {
        ...
        public void Register()=>AFuncIndex<T,R,A,B,C,D>.RegisterFunc(Run);
        public void Register<TScope>(TScope scope) => AFuncIndex<T,R,A,B,C,D>.RegisterFunc(GlobalEvent.GetClassFuncDic(scope), Run);
    ...
    public abstract class AutoClassFunc<T,R, A, B, C, D, E> : IAutoRegisterEvent where T : AFuncIndex<T,R, A, B, C, D, E>
    {
        ...
        public void Register()=>AFuncIndex<T,R, A, B, C, D, E>.RegisterFunc(Run);
        public void Register<TScope>(TScope scope) => AFuncIndex<T,R, A, B, C, D, E>.RegisterFunc(GlobalEvent.GetClassFuncDic(scope), Run);

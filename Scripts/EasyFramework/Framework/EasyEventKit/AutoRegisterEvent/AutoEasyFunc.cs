namespace EasyFramework.EventKit
{
    public abstract class AutoEasyFunc<T,R>: IAutoRegisterEvent where T : struct
    {
        ...
        public void Register()=>EasyFuncDic.Global.Register<T,R>(Run);

        public void Register<TScope>(TScope scope) => GlobalEvent.GetEasyFuncDic(scope).Register<T,R>(Run);
    ...
    public abstract class AutoEasyFunc<T>: IAutoRegisterEvent where T : struct
    {
        ...
        public void Register()=>EasyFuncDic.Global.Register<T>(Run);
        public void Register<TScope>(TScope scope) => GlobalEvent.GetEasyFuncDic(scope).Register<T>(Run);
